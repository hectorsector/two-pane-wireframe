                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        ...
                        N.locales &&
                          ((u = o(I)),
                          (l = n(u.pathname, N.locales)).detectedLocale
                            ? ((u.pathname = l.pathname), (I = i(u)))
                            : (z = N.locale),
                          (f = a(void 0, window.location.hostname)) &&
                            (z = f.defaultLocale)),
                        N.scriptLoader &&
                          (0, r(699).initScriptLoader)(N.scriptLoader),
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 9:
                      if (
                        ((e.prev = 9),
                        (e.t0 = e.catch(4)),
                        !(r = C.getProperError(e.t0)).cancelled)
                      ) {
                        e.next = 14
                        break
                      }
        ...
        return (
          ...
          D.loadPage('/_error')
            .then(function (e) {
              var t = e.page,
                n = e.styleSheets
              return (null == oe ? void 0 : oe.Component) === t
                ? Promise.resolve()
                    .then(function () {
                      return u(r(9185))
                    })
      ...
      var o = r(6495).Z,
        ...
        v = function (e) {
          ...
          if (!g || !p.has(g)) {
            ...
            try {
              for (
                var E, S = Object.entries(e)[Symbol.iterator]();
                !(P = (E = S.next()).done);
                P = !0
              ) {
                var O = n(E.value, 2),
    ...
    6273: function (e, t, r) {
      ...
      function z(e, t) {
        ...
        return '/404' === r || '/_error' === r
          ...
          : (t.includes(r) ||
              t.some(function (t) {
                if (P.isDynamicRoute(t) && O.getRouteRegex(t).re.test(r))
                  return (e = t), !0
              }),
        ...
        ee = (function () {
          function e(t, r, a, o) {
              ...
              (this.onPopState = function (e) {
                ...
                if (r) {
                  if (r.__NA) window.location.reload()
                    ...
                    r.__N &&
                    (!t || E.locale !== r.options.locale || r.as !== E.asPath)
                  ) {
                    var n = r.url,
                      a = r.as,
                      o = r.options,
                    ...
                    ;(E.isSsr &&
                      a === A.addBasePath(E.asPath) &&
                      u === A.addBasePath(E.pathname)) ||
                      (E._bps && !E._bps(r)) ||
                      E.change(
                        'replaceState',
                        n,
            ...
            if (
              ...
              (this.isLocaleDomain = !!R.detectDomainLocale(
                g,
                          ...
                          for (;;)
                            switch ((u.prev = u.next)) {
                              ...
                              case 12:
                                if (
                                  ...
                                  (F = g.normalizeLocalePath(
                                    ...
                                    ((y.locale = F.detectedLocale),
                                    (I.pathname = A.addBasePath(I.pathname)),
                              ...
                              case 25:
                                ...
                                return (
                                  (y.asPath = ne),
                                  e.events.emit('hashChangeStart', n, re),
                                  s.changeState(
                                    t,
                                    r,
                                    n,
                              ...
                              case 47:
                                return (
                                  e.events.emit('hashChangeComplete', n, re),
                                  u.abrupt('return', !0)
                                )
                              case 49:
                                return (
                                  (oe = w.parseRelativeUrl(r)),
                                  (ie = oe.pathname),
                                  (ue = oe.query),
                                  (u.prev = 52),
                                  (u.t1 = i),
                              ...
                              case 68:
                                return (
                                  s.urlIsNew(ne) || ae || (t = 'replaceState'),
                                  (de = n),
                                  (ie = ie
                                    ...
                                    : ie),
                                  (u.next = 73),
                                  te({ asPath: n, locale: y.locale, router: s })
                                )
                              case 73:
                                if (
                                  ((pe = u.sent),
                              ...
                              case 92:
                                ...
                                if (
                                  ((ye = w.parseRelativeUrl(de)),
                                  (ge = ye.pathname),
                                  (_e = O.getRouteRegex(ve)),
                                  (me = S.getRouteMatcher(_e)(ge)),
                                  (Pe = (be = ve === ge) ? B(ve, ge, ue) : {}),
                                  me && (!be || Pe.result))
                                ) {
                                  u.next = 109
                                  break
                                ...
                                if (
                                  !(
                                    (we = Object.keys(_e.groups).filter(
                                      function (e) {
                                        return !ue[e]
                                      }
                                    )).length > 0
                              ...
                              case 110:
                                return (
                                  f || e.events.emit('routeChangeStart', n, re),
                                  (u.prev = 111),
                                  (u.next = 115),
                                  s.getRouteInfo({
                                    route: ve,
                              ...
                              case 115:
                                if (
                                  ('route' in (Se = u.sent) &&
                                    ...
                                    P.isDynamicRoute(ie) &&
                                      ...
                                      (Re = g.normalizeLocalePath(
                                        je,
                                        s.locales
                                      )),
                                      (y.locale =
                                        Re.detectedLocale || y.locale),
                                      (je = Re.pathname),
                                      (Ce = O.getRouteRegex(ie)),
                                      (ke = S.getRouteMatcher(Ce)(je)) &&
                                        Object.assign(ue, ke))),
                                  !('type' in Se))
                                ) {
                                  u.next = 124
                                ...
                                return u.abrupt(
                                  'return',
                                  s.change(t, Se.newUrl, Se.newAs, a)
                                )
                              case 122:
                                return (
                                  J({ url: Se.destination, router: s }),
                                  u.abrupt(
                                    'return',
                                    new Promise(function () {})
                                  )
                              ...
                              case 124:
                                ...
                                if (
                                  ((a.locale = !1),
                                  !(Ie = Le.pageProps.__N_REDIRECT).startsWith(
                                    '/'
                                  ) ||
                                ...
                                return (
                                  ((De = w.parseRelativeUrl(Ie)).pathname = z(
                                    De.pathname,
                                    ce
                                  )),
                                  (qe = W(s, Ie, Ie)),
                                  (Ue = qe.url),
                                  (Be = qe.as),
                                  u.abrupt('return', s.change(t, Ue, Be, a))
                                )
                              case 136:
                                return (
                                  J({ url: Ie, router: s }),
                              ...
                              case 155:
                                if (
                                  (e.events.emit('beforeHistoryChange', n, re),
                                  s.changeState(t, r, n, a),
                                  f &&
                                    '/_error' === ie &&
                                    500 ===
                                      (null ==
                                        (xe = self.__NEXT_DATA__.props) ||
                                      null == (Ee = xe.pageProps)
                                        ? void 0
                                        : Ee.statusCode) &&
                                    (null == Le ? void 0 : Le.pageProps) &&
                                    (Le.pageProps.statusCode = 500),
                                  (Ze =
                                    a.shallow &&
                                    y.route ===
                                      (null != (Fe = Se.route) ? Fe : ve)),
                                  (ze =
                                    null != (We = a.scroll)
                                      ? We
                                      : !a._h && !Ze),
                                  ...
                                  a._h &&
                                    ...
                                    !_ &&
                                    !ae &&
                                    D.compareRouterStates(Ve, s.state))
                                ) {
                                  u.next = 176
                                  break
                                }
                                return (
                                  (u.next = 169),
                                  s.set(Ve, Se, $e).catch(function (e) {
                                    if (!e.cancelled) throw e
                                    Me = Me || e
                                  })
                                )
                              ...
                              case 172:
                                y.locale &&
                                  ...
                                  f ||
                                    e.events.emit('routeChangeComplete', n, re),
                                  (Xe = /#.+$/),
                                  ze && Xe.test(n) && s.scrollToHash(n)
                              case 176:
                ...
                value: function (e) {
                  ...
                  return c(
                    u.default.mark(function e() {
                      var y, _, b, x, E, S, O, R, C, k, M, A, T, N, I
                      return u.default.wrap(
                        function (e) {
                          for (;;)
                            switch ((e.prev = e.next)) {
                              case 0:
                                if (
                                  ((y = t),
                                  (e.prev = 1),
                                  (E = K({ route: y, router: v })),
                                  (S = v.components[y]),
                                  !i.shallow || !S || v.route !== y)
                                ) {
                                  e.next = 7
                                  break
                                }
                              ...
                              case 12:
                                if (
                                  ...
                                  E(),
                                  'redirect-internal' !==
                                    (null == C || null == (_ = C.effect)
                                      ? void 0
                                      : _.type) &&
                                    'redirect-external' !==
                                      (null == C || null == (b = C.effect)
                                        ? void 0
                                        : b.type))
                                ) {
                                  e.next = 16
                              ...
                              case 16:
                                ...
                                if (
                                  ...
                                  (n = l({}, n, C.effect.parsedAs.query)),
                                  (o = L.removeBasePath(
                                    g.normalizeLocalePath(
                                      C.effect.parsedAs.pathname,
                                      v.locales
                                    ).pathname
                                  )),
                                  (S = v.components[y]),
                                  !i.shallow || !S || v.route !== y || f)
                                ) {
                                  e.next = 24
                                  break
                                }
                              ...
                              case 37:
                                return (
                                  (M = k.__N_RSC && k.__N_SSP),
                                  (A = k.__N_SSG || k.__N_SSP || k.__N_RSC),
                                  (e.next = 41),
                                  v._getData(
                                    c(
                                      u.default.mark(function e() {
                            ...
                            case 22:
                              ;(v = M.removeLocale(
                                ...
                                x.matchedPage &&
                                  ...
                                  ((i = x.resolvedHref),
                                  (o.pathname = i),
                                  y || (e = j.formatWithValidation(o)))
                            case 24:
                              ;(o.pathname = z(o.pathname, d)),
                              ...
                              if (
                                ('rewrite' ===
                                  (null == (R = a.sent)
                                    ? void 0
                                    : R.effect.type) &&
                                  ((o.pathname = R.effect.resolvedHref),
                                  (i = R.effect.resolvedHref),
                                  (c = l({}, c, R.effect.parsedAs.query)),
                                  (v = R.effect.parsedAs.pathname),
                                  (e = j.formatWithValidation(o))),
                                'redirect-external' !==
      ...
      function te(e) {
        return Promise.resolve(e.router.pageLoader.getMiddleware()).then(
          function (t) {
            ...
            return !!a && new RegExp(a).test(k.addLocale(n, e.locale))
          }
        )
      }
      function re(e) {
                      ...
                      if (o.startsWith('/')) {
                        ...
                        return Promise.all([
                          ...
                          var n = i(t, 2),
                            o = n[0],
                            u = n[1].__rewrites,
                            l = k.addLocale(s.pathname, s.locale)
                          if (
                            P.isDynamicRoute(l) ||
                            (!a &&
                              o.includes(
                          ...
                          p.matchedPage &&
                            ((c.pathname = p.parsedAs.pathname),
                            (l = c.pathname),
                            Object.assign(c.query, p.parsedAs.query))
                          var h = o.includes(f)
                            ? f
                            : z(
                                g.normalizeLocalePath(
                                  L.removeBasePath(c.pathname),
                                  r.router.locales
                                ).pathname,
                                o
                              )
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.prepareDestination = function (e) {
          ...
          var E = o.compile(_, { validate: !1 }),
            S = o.compile(b, { validate: !1 }),
            O = !0,
            j = !1,
            R = void 0
          try {
            for (
              var C, k = Object.entries(g)[Symbol.iterator]();
              !(O = (C = k.next()).done);
              O = !0
            ) {
              var M = n(C.value, 2),
          ...
          return (
            (y.query = a({}, t, y.query)),
            { newUrl: T, destQuery: g, parsedDestination: y }
          )
        })
      var a = r(6495).Z,
        o = r(4329),
