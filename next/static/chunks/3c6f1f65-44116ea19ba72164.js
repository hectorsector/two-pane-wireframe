...
;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [593],
  {
    9283: function (t, e, a) {
      ...
      var n = a(7294)
      var c = { small: 16, medium: 32, large: 64 }
      function l(t, e, a) {
        var l = a(),
          i = Object.keys(l)
        function r(t) {
          var a = t['aria-label'],
            ...
            h = void 0 === o ? e : o,
            d = t.fill,
            u = void 0 === d ? 'currentColor' : d,
            p = t.size,
            f = void 0 === p ? 16 : p,
            m = t.verticalAlign,
            w = void 0 === m ? 'text-bottom' : m,
            Z = c[f] || f,
            v = (function (t, e) {
              return t
                .map(function (t) {
          ...
          return n.createElement(
            'svg',
            {
              ...
              tabIndex: r,
              focusable: r >= 0 ? 'true' : 'false',
              'aria-label': a,
              role: 'img',
              className: h,
              viewBox: '0 0 '.concat(E, ' ').concat(v),
              width: s,
              height: Z,
              fill: u,
              style: {
      ...
      var i = l('AlertFillIcon', 'octicon octicon-alert-fill', function () {
          return {
            12: {
              width: 12,
        ...
        r = l('CheckIcon', 'octicon octicon-check', function () {
          return {
            16: {
              width: 16,
              path: n.createElement('path', {
        ...
        h = l('ChevronDownIcon', 'octicon octicon-chevron-down', function () {
          return {
            12: {
              width: 12,
              path: n.createElement('path', {
        ...
        d = l('ChevronRightIcon', 'octicon octicon-chevron-right', function () {
          return {
            12: {
              width: 12,
              path: n.createElement('path', {
        ...
        f = l('PlusIcon', 'octicon octicon-plus', function () {
          return {
            16: {
              width: 16,
              path: n.createElement('path', {
        ...
        m = l('TriangleDownIcon', 'octicon octicon-triangle-down', function () {
          return {
            16: {
              width: 16,
              path: n.createElement('path', {
        ...
        w = l('XIcon', 'octicon octicon-x', function () {
          return {
            16: {
              width: 16,
              path: n.createElement('path', {
